<template>
  ...
  <nav id="nav" class="container mx-auto">
    ...
    >
      <div class="flex items-center justify-between">
        ...
        <!-- <theme-switcher
          ...
          "
        /> -->
        <!-- Boton Menú cuando estamos en dispositivos pequeños, intercambiamos el botón -->
        <div class="sm:hidden">
      ...
      <!-- Menú de navegación. Segúb este abierto la navgeacion em oviles lo ponemos como bloque o no -->
      <div
    ...
    <!-- Comienzo del modal de contacto -->
